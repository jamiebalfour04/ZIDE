...
public final class CLanguage extends LanguageSupport {
  ...
  @Override public void configure(CodeEditorViewFX editor) {
    ...
    addContext(editor, "math", "acos", "asin", "atan", "atan2", "ceil", "cos", "exp", "fabs", "floor", "fmod", "log", "log10", "pow", "sin", "sqrt", "tan");
    addContext(editor, "stdio", "printf", "scanf", "puts", "fopen", "fclose", "fread", "fwrite", "perror");
    addContext(editor, "string", "memcpy", "memmove", "memset", "memcmp", "strcat", "strcmp", "strcpy", "strlen", "strstr");
